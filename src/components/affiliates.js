...
<div className="school-form">
  <form onSubmit={handleSubmit}>
    ...
    <div className='school-items'>School Name: <input type='text' value={school_name} onChange={(e)=>setSchool_name(e.target.value)} required id="school-name"></input></div>
    <div className='school-items'>School Address: <input type='text' value={school_address} onChange={(e)=>setSchoolAddress(e.target.value)} required id="school-Address"></input></div>
    <div className='school-items'>School Website(if applicable): <input type='text' value={schoolWebsite} onChange={(e)=>setSchoolWebsite(e.target.value)} id="school-website"></input></div>
    <div className='school-items'>Contact Person: <input type='text' value={contactPerson} onChange={(e)=>setContactPerson(e.target.value)} required id="Contact-Person"></input></div>
    <div className='school-items'>Contact Email: <input type='text' value={contactEmail} onChange={(e)=>setContactEmail(e.target.value)} required id="Contact-email"></input></div>
    <div className='school-items'>Contact Phone Number: <input type='text' value={contactphone} onChange={(e)=>setContactPhone(e.target.value)} required id="Contact-Phone"></input></div>
    <div className='school-items'>City: <input type='text' value={cityP} onChange={(e)=>setCityP(e.target.value)} required id="City"></input></div>
    <div className='school-items'>State: <input type='text' value={stateP} onChange={(e)=>setStateP(e.target.value)} required id="State"></input></div>
    <div className='school-items'>Pincode: <input type='text' value={pinCode} onChange={(e)=>setPinCode(e.target.value)} required id="Pincode"></input></div>
    <div className='school-items'>Coordinator 1 Name: <input type='text' value={cordinator1_name} onChange={(e)=>setCordinator1_name(e.target.value)} required id="Coordinator 1 Name"></input></div>
    <div className='school-items'>Coordinator 2 Name: <input type='text' value={cordinator2_name} onChange={(e)=>setCordinator2_name(e.target.value)} required id="Coordinator 2 Name"></input></div>
    <div className='school-items'>Coordinator 1 Contact Email Id: <input type='text' value={cordi1_conatctEmail} onChange={(e)=>setCordi1_contactEmail(e.target.value)} required id="email-info-1"></input></div>
    <div className='school-items'>Coordinator 2 Contact Email Id: <input type='text' value={cordi2_conatctEmail} onChange={(e)=>setCordi2_contactEmail(e.target.value)} required id="email-info-2"></input></div>
    <div className='school-items'>Coordinator 1 Contact Number: <input type='text' value={cordi1_conatctNo} onChange={(e)=>setCordi1_contactNo(e.target.value)} required id="contact-info-1"></input></div>
    <div className='school-items'>Coordinator 2 Contact Number: <input type='text' value={cordi2_conatctNo} onChange={(e)=>setCordi2_contactNo(e.target.value)} required id="contact-info-2"></input></div>
    ...
    <div className='school-form-ahead'>
      <div className='school-items'>Upload Payment Screenshot<input type="file" required onChange={handleFilechange1}/></div>
    </div>
    ...
    <div className='last_check'>
        ...
        <p>Declaration by the head of the institution, confirming participation in India's fight against climate change.<br></br>
        <div></div>
...
<p className='Aff-p'>Affliation certificate will be sent on provided Contact Email in 4-6 working days.</p>
