...
export default function Ylpa() {
  ...
  return (
    <>
      ...
      <p className='con-mind2_ylp'>India’s most powerful Leadership Program for the YOUTH</p>
      ...
      <div className='com-perk-eli2'>
        <p><span className='perk-head'>Confident Leadership Presence:<br></br>  </span> Outcome: Participants develop a confident and authentic leadership presence. <br /> Impact: They can inspire and influence others with their clarity of purpose and self-assured communication.
        </p>
        <p><span className='perk-head'>Global Citizenship Mindset:<br></br> </span> Outcome: Participants cultivate a global citizenship mindset. <br /> Impact: They understand their role in a connected world, appreciating diversity, and addressing global challenges with empathy.</p>

        <p><span className='perk-head'>Holistic Self-Discovery:<br></br> </span> Outcome: Participants undergo a holistic self-discovery journey. <br />
          Impact: They gain clarity on personal values, strengths, and purpose, fostering a strong foundation for effective leadership.
        </p>

        <p><span className='perk-head'>Effective Communication Skills:
          <br></br> </span> Outcome: Participants master effective communication and public speaking. <br />
          Impact: They articulate ideas confidently, whether addressing a small team or a larger audience, enhancing their influence.
        </p>

        <p><span className='perk-head'>Practical Goal Setting and Time Management:<br></br> </span> Outcome: Participants acquire practical goal-setting and time management skills. <br />
          Impact: They learn to set and achieve ambitious yet realistic goals, fostering a proactive and results-oriented mindset.
        </p>

        <p><span className='perk-head'>Community Impact Initiatives:
          <br></br> </span> Outcome: Participants initiate and lead community impact projects. <br />
          Impact: They contribute positively to their communities, applying leadership skills to address real-world challenges.
        </p>

        <p><span className='perk-head'>Network and Mentorship Connections:
          <br></br> </span>  Outcome: Participants build a valuable network and engage in mentorship. <br />
          Impact: They establish connections with like-minded peers and experienced mentors, enhancing their personal and professional growth.
        </p>

        <p><span className='perk-head'>Lead the climate action movement:
          <br></br> </span>  Outcome: Participants embrace sustainable leadership practices. <br />
          Impact: They understand the importance of ethical and sustainable leadership, contributing to long-term positive impacts on the environment and society.
        </p>

        <p><span className='perk-head'>Become a youth icon:
          <br></br>  </span>   Outcome: Participants successfully complete a capstone leadership project. <br />
