...
export default function Home() {
  ...
  return (
    ...
    <div className="about">
      ...
      <p className="pabout">A joint initiative of Gaia The Earth Foundation and BuzzOnEarth, India MUN is the country’s first climate themed MUN, which provides a platform where student delegates follow, analyse and contribute to, the United Nations’ effort to mitigate climate change. Its climate-positive programs, competitions and events help transform activism into action by enabling students – our future sustainability leaders, to brainstorm positive climate actions and network with peers who care equally for the planet.</p>
    ...
    <div className="my-container">
      <div className="left-container">
        <div className="upper-text">Schools for Climate Action.</div>
    ...
    <h1 className='head-am'>INDIA'S YOUNG FOREST AMBASSADOR<span> (REGISTRATION'S OPEN)</span></h1>
